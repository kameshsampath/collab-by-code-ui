        ...
        <div class="card">
          <div class="card-body">
            <blockquote class="blockquote mb-0">
              <p>We wanted to create an open source project called “Collaborate by Code” that taught the principles of open source to the Red Hat community in an engaging and innovative way.</p>
              <footer class="blockquote-footer">Grace C. and Fiona W.</footer>
            </blockquote>
          </div>
        </div>
      </div>
